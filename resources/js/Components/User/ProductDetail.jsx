    ...
    useEffect(() => {
      ...
      if (foundProduct) {
        ...
        setRecommendedProducts(
          products.filter((p) => p.category === foundProduct.category && p.id !== foundProduct.id)
        );
      }
    }, [id]);
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 p-4">
            ...
            {product.discountedPrice ? (
              <div className="mb-4">
                <span className="line-through text-red-500 text-xl">Rp. {product.originalPrice}</span>
            ...
            {recommendedProducts.map((recommendedProduct) => (
              ...
              >
                <Link to={`/product/${recommendedProduct.id}`}>
                  ...
                  />
                  <h3 className="font-semibold text-md text-gray-800">{recommendedProduct.name}</h3>
                </Link>
                {recommendedProduct.discountedPrice ? (
                  ...
                  <p className="mt-2 text-gray-800 font-bold">Rp. {recommendedProduct.price}</p>
                )}
              </div>
            ))}
          </div>
